...
def main(route) -> Tuple[bool, Dict]:
    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            # if is_amide_coupling or not is_amide_coupling: # Check ring systems regardless of amide coupling detection
                ...
                for ring_type in HETEROCYCLIC_PARTNERS:
                    if checker.check_ring(ring_type, r):
                        ...
                        if ring_type not in findings_json["atomic_checks"]["ring_systems"]:
                            rings.append(ring_type)
                            
                findings_json["atomic_checks"]["ring_systems"].append(rings)
