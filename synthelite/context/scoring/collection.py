...
from synthelite.context.scoring.scorers import __name__ as scorers_module
...
if TYPE_CHECKING:
    ...
    from synthelite.utils.type_utils import Any, List, Sequence, TypeVar, Union
...
class ScorerCollection(ContextCollection):
    """
    Store scorer objects for the synthelite interface.
    ...
    def load_from_config(self, **scorers_config: Any) -> None:
        ...
        defined in the ``synthelite.context.scoring`` module, the module
