...
from synthelite.chem import TemplatedRetroReaction
from synthelite.context.policy.utils import _make_fingerprint
from synthelite.utils.bonds import BrokenBonds
...
if TYPE_CHECKING:
    ...
    from synthelite.utils.type_utils import Any, Dict, List, Optional, Tuple
...
# class BondFilterByReference(FilterStrategy):

#     _required_kwargs: List[str] = ["ref_actions"]

#     def __init__(self, key, config, **kwargs):
#         super().__init__(key, config, **kwargs)
#         self._ref_actions = kwargs["ref_actions"]
#         self._depth = None

#     @property
#     def depth(self):
#         if self._depth is None:
#             raise ValueError("Depth not set")
#         return self._depth
