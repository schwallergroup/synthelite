...
from synthelite.utils.bonds import sort_bonds
...
class TreeMolecule(Molecule):
    ...
    def __init__(
        self,
        parent: Optional["TreeMolecule"] = None,
        ...
        self.llm_next_step_query: Optional[str] = None
        self.strategic_alignment: Optional[float] = None
